...
//> CLASS -> EVALUATE
impl Class {
    pub fn evaluate(&self, context: &mut Context, id: u32, memory: &Vec<Class>) -> Object {return self.result(match self {
        Class::_Annotation(class) => class.evaluate(context, id, memory),
        Class::_Comment(class) => class.evaluate(context, id, memory),
        Class::_Declaration(class) => class.evaluate(context, id, memory),
        Class::_Definition(class) => class.evaluate(context, id, memory),
        Class::_Equation(class) => class.evaluate(context, id, memory),
        Class::_Expression(class) => class.evaluate(context, id, memory),
        Class::_Factor(class) => class.evaluate(context, id, memory),
        Class::_Infinite(class) => class.evaluate(context, id, memory),
        Class::_Limit(class) => class.evaluate(context, id, memory),
        Class::_Nest(class) => class.evaluate(context, id, memory),
        Class::_Node(class) => class.evaluate(context, id, memory),
        Class::_Number(class) => class.evaluate(context, id, memory),
        Class::_Start(class) => class.evaluate(context, id, memory),
        Class::_Tensor(class) => class.evaluate(context, id, memory),
        Class::_Term(class) => class.evaluate(context, id, memory),
        Class::_Use(class) => class.evaluate(context, id, memory),
        Class::_Variable(class) => class.evaluate(context, id, memory)
    })}
}
