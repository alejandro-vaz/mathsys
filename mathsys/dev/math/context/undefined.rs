...
use crate::{Infinite, Integer, Natural, Nexists, Rational, Tensor, Variable, Whole};
...
//> UNDEFINED -> STRUCT
#[derive(Clone)]
pub struct Undefined {} impl Undefined {pub fn new() -> Object {return Object::Undefined(Undefined {})}}
